...
import Geolocation, { GeolocationError, GeolocationOptions } from '@react-native-community/geolocation';
        ...
        Geolocation.getCurrentPosition(
          ...
          (error: GeolocationError) => {
            if (error.code === 2) {
              ...
              showToast('Ubicación desactivada. Por favor actívala en Ajustes.', 'error');
              isEnabled = false;
            }
            resolve();
          },
